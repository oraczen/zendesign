"use strict";
(self["webpackChunkzendesign"] = self["webpackChunkzendesign"] || []).push([["vendors-node_modules_radix-ui_react-label_dist_index_mjs-node_modules_class-variance-authorit-28cf60"],{
...
function useController(props) {
    ...
    return {
        field: {
            ...
            ref: react__WEBPACK_IMPORTED_MODULE_0___default().useCallback((elm) => {
                const field = get(control._fields, name);
                if (field && elm) {
                    field._f.ref = {
                        focus: () => elm.focus(),
...
//# sourceMappingURL=vendors-node_modules_radix-ui_react-label_dist_index_mjs-node_modules_class-variance-authorit-28cf60.iframe.bundle.js.map