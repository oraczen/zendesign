"use strict";
(self["webpackChunkzendesign"] = self["webpackChunkzendesign"] || []).push([["vendors-node_modules_class-variance-authority_dist_index_mjs-node_modules_vaul_dist_index_mjs"],{
...
const DrawerContext = react__WEBPACK_IMPORTED_MODULE_0___default().createContext({
    drawerRef: {
        current: null
    },
    overlayRef: {
...
function useSnapPoints({ activeSnapPointProp, setActiveSnapPointProp, snapPoints, drawerRef, overlayRef, fadeFromIndex, onSnapPointChange, direction = 'bottom', container, snapToSequentialPoint }) {
    ...
    const [windowDimensions, setWindowDimensions] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(typeof window !== 'undefined' ? {
 ...
 */ function usePositionFixed({ isOpen, modal, nested, hasBeenOpened, preventScrollRestoration, noBodyStyles }) {
    const [activeUrl, setActiveUrl] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(()=>typeof window !== 'undefined' ? window.location.href : '');
...
function Root({ open: openProp, onOpenChange, children, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, shouldScaleBackground = false, setBackgroundColorOnScale = true, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, handleOnly = false, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, nested, noBodyStyles = false, direction = 'bottom', defaultOpen = false, disablePreventScroll = true, snapToSequentialPoint = false, preventScrollRestoration = false, repositionInputs = true, onAnimationEnd, container, autoFocus = false }) {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_radix_ui_react_dialog__WEBPACK_IMPORTED_MODULE_1__.Root, {
...
const Overlay = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(function({ ...rest }, ref) {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_radix_ui_react_dialog__WEBPACK_IMPORTED_MODULE_1__.Overlay, {
        onMouseUp: onMouseUp,
        ref: composedRef,
        "data-vaul-overlay": "",
...
const Content = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(function({ onPointerDownOutside, style, onOpenAutoFocus, ...rest }, ref) {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_radix_ui_react_dialog__WEBPACK_IMPORTED_MODULE_1__.Content, {
...
function Portal(props) {
    ...
    return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_radix_ui_react_dialog__WEBPACK_IMPORTED_MODULE_1__.Portal, {
        container: container,
        ...portalProps
    });
}
...
//# sourceMappingURL=vendors-node_modules_class-variance-authority_dist_index_mjs-node_modules_vaul_dist_index_mjs.iframe.bundle.js.map