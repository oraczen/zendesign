"use strict";
(self["webpackChunkzendesign"] = self["webpackChunkzendesign"] || []).push([["vendors-node_modules_radix-ui_react-navigation-menu_dist_index_mjs-node_modules_class-varianc-8577bc"],{
...
function createCollection(name) {
  ...
  const CollectionProvider = (props) => {
    ...
    const itemMap = react__WEBPACK_IMPORTED_MODULE_0___default().useRef(/* @__PURE__ */ new Map()).current;
  ...
  const CollectionSlot = react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(
    (props, forwardedRef) => {
      const { scope, children } = props;
  ...
  const CollectionItemSlot = react__WEBPACK_IMPORTED_MODULE_0___default().forwardRef(
    (props, forwardedRef) => {
...
//# sourceMappingURL=vendors-node_modules_radix-ui_react-navigation-menu_dist_index_mjs-node_modules_class-varianc-8577bc.iframe.bundle.js.map